...
import { HouseAttributesModule } from './house-attributes/house-attributes.module';

@Module({
  imports: [ConfigModule.forRoot({
    isGlobal: true,
  }), UserModule, UserLoginModule, UserTokenModule, UserAttributesModule, RoommatesPrefrencesModule, HouseListingModule, HouseSearchPrefrencesModule, HouseAttributesModule],
